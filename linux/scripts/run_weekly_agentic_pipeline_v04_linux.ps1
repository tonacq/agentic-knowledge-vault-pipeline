...
function Get-ClaudeAuthenticationRemediation {
    ...
    $message = @(
        ...
        "Run these commands interactively as the SAME Linux account that runs the pipeline:",
        "",
        "    claude auth login",
        "    'AUTH_OK' | claude -p",
        "",
        "Then rerun the pipeline.",
        "For unattended systemd execution, the service must run under that same authenticated account."
    )
